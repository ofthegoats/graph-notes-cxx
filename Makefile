#############################################################################
# Makefile for building: graph-notes-cxx
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  graph-notes-cxx.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile graph-notes-cxx.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = graph-notes-cxx1.0.0
DISTDIR = /home/piotr/Desktop/git/graph-notes-cxx/.tmp/graph-notes-cxx1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		graph-notes-cxx.pro database.hpp \
		graph.hpp \
		ui/MainWindow.h database.cpp \
		graph.cpp
QMAKE_TARGET  = graph-notes-cxx
DESTDIR       = 
...
graph-notes-cxx: ui_MainWindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: graph-notes-cxx.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		graph-notes-cxx.pro
	$(QMAKE) -o Makefile graph-notes-cxx.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents database.hpp graph.hpp ui/MainWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents database.cpp graph.cpp $(DISTDIR)/
